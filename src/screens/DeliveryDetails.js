...
import { Text, View, TouchableOpacity, TextInput, Alert, Button, ScrollView } from 'react-native';
        ...
        <ScrollView>
            ...
            <View style={{
				...
				<DropDownPicker
						...
						marginRight: 20, marginTop:5, marginBottom: 10}}
            ...
            <TouchableOpacity style={{
					...
					<Text style={{color: "white", fontWeight: "bold", textAlign: "center"}}> Save Details</Text>
					</TouchableOpacity>
                </View>
        </ScrollView>
